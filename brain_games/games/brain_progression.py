...
def question_and_answer():
    initial_term = random.randint(START, END)
    difference = random.randint(DIFF_START, DIFF_END)
    prog_length = random.randint(LENGTH_MIN, LENGTH_END)
    rand_num = random.randint(LENGTH_START, prog_length)
